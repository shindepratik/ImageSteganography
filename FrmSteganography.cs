...
namespace Steganography
{
    public partial class FrmSteganography : Form
    {
        ...
        private void Encrypt_btn_MouseEnter(object sender, EventArgs e)
        {
            Encrypt_btn.BackColor = Color.Maroon;
        }

        private void Encrypt_btn_MouseLeave(object sender, EventArgs e)
        {
            Encrypt_btn.BackColor = Color.Transparent;
        }

        private void Decrypt_btn_MouseEnter(object sender, EventArgs e)
        {
            Decrypt_btn.BackColor = Color.Maroon;
        }

        private void Decrypt_btn_MouseLeave(object sender, EventArgs e)
        {
        ...
        private void EnImageBrowse_btn_MouseEnter(object sender, EventArgs e)
        {
            EnImageBrowse_btn.BackColor = Color.Maroon;
        }

        private void EnImageBrowse_btn_MouseLeave(object sender, EventArgs e)
        {
            EnImageBrowse_btn.BackColor = Color.Transparent;
        }

        private void EnFileBrowse_btn_MouseEnter(object sender, EventArgs e)
        {
            EnFileBrowse_btn.BackColor = Color.Maroon;
        }

        private void EnFileBrowse_btn_MouseLeave(object sender, EventArgs e)
        {
            EnFileBrowse_btn.BackColor = Color.Transparent;
        }

        private void DeLoadImageBrowse_btn_MouseEnter(object sender, EventArgs e)
        {
            DeLoadImageBrowse_btn.BackColor = Color.Maroon;
        }

        private void DeLoadImageBrowse_btn_MouseLeave(object sender, EventArgs e)
        {
            DeLoadImageBrowse_btn.BackColor = Color.Transparent;
        }

        private void DeSaveFileBrowse_btn_MouseEnter(object sender, EventArgs e)
        {
            DeSaveFileBrowse_btn.BackColor  = Color.Maroon;
        }

        private void DeSaveFileBrowse_btn_MouseLeave(object sender, EventArgs e)
        {
            DeSaveFileBrowse_btn.BackColor  = Color.Transparent;
        }
